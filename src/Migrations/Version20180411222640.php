 ...
 */
class Version20180411222640 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ramen ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ramen ADD CONSTRAINT FK_34255F1AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_34255F1AA76ED395 ON ramen (user_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_34255F1AA76ED395 ON ramen');
        $this->addSql('ALTER TABLE ramen DROP user_id');
